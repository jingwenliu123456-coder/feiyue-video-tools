...
class VideoBatchProcessor:
    def __init__(self, root):
        self.root = root
        self.root.title("视频批量处理工具 v14.0")
    ...
    def setup_ui(self):
        ...
        # === 标题 ===
        ttk.Label(scrollable_frame, text="视频批量处理工具 v14.0", font=("Microsoft YaHei", 18, "bold")).pack(pady=(0,5))
    ...
    def process_all(self):
        # 判断使用哪种模式：重命名区有文件就用映射模式，否则用输入/输出文件夹模式
