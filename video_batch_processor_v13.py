...
class VideoBatchProcessor:
    def __init__(self, root):
        self.root = root
        self.root.title("视频批量处理工具 v13.0")
    ...
    def setup_ui(self):
        ...
        # === 标题 ===
        ttk.Label(scrollable_frame, text="视频批量处理工具 v13.0", font=("Microsoft YaHei", 18, "bold")).pack(pady=(0,5))
        ...
        top_btn_frame.pack(fill=tk.X, pady=15)
        ...
        top_btn_frame.pack(anchor=tk.CENTER)  # 居中
        ...
        self.src_listbox = tk.Listbox(left_frame, height=6, width=55, exportselection=False)
        ...
        ttk.Label(mid_frame, text="→", font=("Arial", 20)).pack(pady=(30,5))
        ...
        self.dst_listbox = tk.Listbox(right_frame, height=6, width=55, exportselection=False)
    ...
    def show_help(self):
        messagebox.showinfo("使用说明",
            "1. 选择源文件夹和目标文件夹（底部重命名区）\n"
            "2. 勾选需要的功能，设置参数（中部功能区）\n"
            "3. 点击顶部【一键批量处理】\n\n"
