...
class VideoBatchProcessor:
    def __init__(self, root):
        self.root = root
        self.root.title("视频批量处理工具 v15.0")
    ...
    def setup_ui(self):
        ...
        ttk.Label(scrollable_frame, text="视频批量处理工具 v15.0", font=("Microsoft YaHei", 18, "bold")).pack(pady=(0,5))
    ...
    def add_cta(self, inp, cta, out, keep_audio, trim_sec=0):
        ...
        try:
            ...
            if os.path.exists(list_file):
                os.remove(list_file)
            if trim_sec > 0 and os.path.exists(cta_trimmed):
                try:
